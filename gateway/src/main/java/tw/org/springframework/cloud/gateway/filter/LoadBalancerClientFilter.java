...
package tw.org.springframework.cloud.gateway.filter;
...
/**
 * Add by Leo, 解決GateWay Mapping consul service url 沒有contextpath 的問題
 * @author Spencer Gibb
 * @author Tim Ysewyn
 */
public class LoadBalancerClientFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		System.out.println("LoadBalancerClientFilter url before: " + url);
		...
		// Add by Leo : Refactor Context Path
		if(instance.getMetadata() != null) {
			String contextPath = instance.getMetadata().get("contextPath");
			
			if(contextPath != null) {
				
				System.out.println("RefactorContextPath ： contextPath="+contextPath);
		...
		System.out.println("LoadBalancerClientFilter url chosen: " + requestUrl);
